<?php 
/*
 * @link             http://plugin.wpthemespace.com
 * @since             1.0.0
 * @package           Palto Carousel
 *
 * @wordpress-plugin
 * Plugin Name:       Palto Carousel
 * Plugin URI:        http://plugin.wpthemespace.com
...
wp_enqueue_script( 'pcarousel-aslick.min', plugins_url( '/assets/js/slick.min.js', __FILE__ ), array( 'jquery' ), '1.0', true);
