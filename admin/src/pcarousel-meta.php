...
function palto_carousel_meta_options() {
	...
	$palto_carousel->add_field( array(
		'name'    => __( '', 'palto' ),
		'desc'    => __( 'The plugin create by <a id="add_pro" class="button" href="https://wpthemespace.com" target="_blank">wp theme space</a> Please visite the site for free and premium themes. <a id="add_pro" class="button" href="https://wpthemespace.com" target="_blank">Visit Now</a>', 'palto' ),
		'id'      => 'wpspace_info',
		'type'    => 'text',
...
function texst_sidebar(){ 
 $cmb = new_cmb2_box( array(
        'id'           => 'test_metabox',
        'title'        => 'Advance Carousel Box',
        'object_types' => array( 'palto-carousel' ), // post type
      ...
      $cmb->add_field( array(
        'name'       => __( 'Advance Carousel Box', 'cmb2' ),
        'desc'       => __( ' 
            <a id="add_pro" class="button" href="http://bit.ly/2APU321" target="_blank">Get Pro Only $15</a>
            <a id="add_pro" class="button" href="https://wpthemespace.com/themes" target="_blank">See Best WordPress Themes</a>
            <div class="add-carousel">
                <a href="https://wpthemespace.com/product/niso-carousel/" target="_blank">
                <img src="'.plugin_dir_url( dirname( __FILE__ ) ) .'../assets/img/image.png" alt="image carousel" />
                </a>
                <a href="https://wpthemespace.com/product/niso-carousel/" target="_blank">
                <img src="'.plugin_dir_url( dirname( __FILE__ ) ) .'../assets/img/video.png" alt="image carousel" />
                </a>
                <a href="https://wpthemespace.com/product/niso-carousel/" target="_blank">
                <img src="'.plugin_dir_url( dirname( __FILE__ ) ) .'../assets/img/post-carousel.png" alt="image carousel" />
                </a>
                <a href="https://wpthemespace.com/product/niso-carousel/" target="_blank">
                <img src="'.plugin_dir_url( dirname( __FILE__ ) ) .'../assets/img/product-carousel.png" alt="image carousel" />
                </a>
                <a href="https://wpthemespace.com/product/niso-carousel/" target="_blank">
                <img src="'.plugin_dir_url( dirname( __FILE__ ) ) .'../assets/img/portfolio-carousel.png" alt="image carousel" />
                </a>
                <a href="https://wpthemespace.com/product/niso-carousel/" target="_blank">
                <img src="'.plugin_dir_url( dirname( __FILE__ ) ) .'../assets/img/services-carousel.png" alt="image carousel" />
                </a>
                <a href="https://wpthemespace.com/product/niso-carousel/" target="_blank">
                <img src="'.plugin_dir_url( dirname( __FILE__ ) ) .'../assets/img/Team-carousel.png" alt="Team-carousel" />
                </a>
                <a href="https://wpthemespace.com/product/niso-carousel/" target="_blank">
                <img src="'.plugin_dir_url( dirname( __FILE__ ) ) .'../assets/img/Testimonial-carousel.png" alt="Testimonial-carousel" />
                </a>
            </div>
...
add_action( 'cmb2_init', 'texst_sidebar' );

//Admin notice 
if( !function_exists('palto_admin_notice')):
function palto_admin_notice() {
    global $pagenow;
    ...
    $message = __( '<strong><span style="color:red;">Latest WordPress Theme:</span>  <span style="color:green"> If you find a Secure, SEO friendly, full functional premium WordPress theme for your site then </span>  </strong>', 'palto' );

    printf( '<div class="%1$s" style="padding:10px 15px 20px;"><p>%2$s <a href="%3$s" target="_blank">'.__('see here','palto' ).'</a>.</p><a target="_blank" class="button button-danger" href="%3$s" style="margin-right:10px">'.__('View WordPress Theme','palto').'</a></div>', esc_attr( $class ), wp_kses_post( $message ),$url1 ); 
}
add_action( 'admin_notices', 'palto_admin_notice' );
endif;